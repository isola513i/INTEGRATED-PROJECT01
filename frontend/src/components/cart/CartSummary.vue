  ...
  >
    ...
    <section class="divide-y divide-gray-200">
      ...
      <div class="pb-4">
        ...
        <div class="space-y-1.5">
          ...
          <textarea
            ...
            class="text-gray-900 w-full rounded-lg border border-gray-300 focus:border-black focus:ring-0 text-sm p-3 shadow-inner placeholder:text-gray-400 transition"
          ></textarea>
        </div>
      ...
      <div class="pt-4">
        ...
        <button
          class="itbms-place-order-button mt-4 w-full rounded-lg border border-black bg-white text-black py-2.5 font-medium transition
                 hover:bg-black hover:text-white focus:ring-2 focus:ring-black/20
