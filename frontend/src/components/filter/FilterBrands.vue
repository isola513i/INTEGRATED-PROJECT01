  ...
  <div class="space-y-4">
    ...
    <div class="flex flex-wrap gap-4 items-center">
      ...
      >
        ...
        <button
          @click="addBrand"
          class="bg-gray-800 hover:bg-blue-600 text-white px-4 h-[42px] text-sm font-medium"
        >
          +
        </button>
        ...
        <button
          @click="clearAll"
          class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 h-[42px] text-sm font-medium"
        >
          Clear
        </button>
      </div>
      ...
      <div class="flex items-center gap-2 h-[42px]">
        ...
        <select
          id="pageSize"
          v-model="pageSize"
          class="border border-gray-300 px-3 h-full rounded-lg text-gray-700 text-sm focus:ring-2 focus:ring-blue-400 focus:outline-none"
        >
