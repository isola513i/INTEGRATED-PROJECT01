...
<template>
  <div class="pt-[55px] bg-white">
    <div
      v-if="product"
      class="max-w-7xl itbms-row mx-auto p-6 grid grid-cols-1 md:grid-cols-2 gap-10"
    >
      <!-- Main Image & Gallery -->
      <div>
        <div
      ...
      <!-- Product Details -->
      <div>
        <div class="itbms-brand text-sm text-gray-500 mb-2">
          {{ product.brandName }}
        </div>
            ...
            >
              ...
              <div class="font-medium text-gray-800">
                <span class="itbms-ramGb">
                  {{ product.ramGb ? product.ramGb : "-" }}</span
                >
            ...
            >
              ...
              <div class="font-medium text-gray-800">
                <span class="itbms-screenSizeInch">{{
                  product.screenSizeInch ? product.screenSizeInch : "-"
                }}</span>
        ...
        <div class="mt-5">
          <div class="text-sm text-gray-500 mb-2">
            <span class="itbms-quantity"
              >Avialable Quatity : {{ product.quantity }}</span
            >
        ...
        >
          ...
          <div class="mt-5">
            ...
            >
              <p
                class="text-gray-700 whitespace-pre-line break-words itbms-description"
              >
                {{ product.description }}
              </p>
            </div>
