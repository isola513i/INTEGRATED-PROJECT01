...
<template>
  <nav class="bg-[#0A1123] fixed w-full z-50 text-white px-3 py-3">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
      ...
      <div class="flex items-center space-x-3">
        ...
        <div class="relative hidden sm:block">
          ...
          <svg class="w-4 h-4 absolute left-3 top-2.5 text-gray-500" fill="none" stroke="currentColor" stroke-width="2"
            viewBox="0 0 24 24">
